...
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Add New Facility</h1>
    ...
    <div class="modal fade" id="editCategoryModal" tabindex="-1" aria-labelledby="editCategoryModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editCategoryModalLabel">Edit Facility</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="editCategoryForm" method="POST" action="{{ url('/facility/{id}') }}">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            ...
                            <td class="d-flex flex-row gap-2 ">
                                ...
                                <form action="/facility/{{ $item->id }}" method="POST">
                                    ...
                                    <button class="btn btn-danger"
                                        onclick="return confirm('Are you sure you want to delete this facility?')"><i
    ...
    <script>
        $(document).ready(function() {
            $('.edit-btn').click(function() {
                ...
                $('#editCategoryModal #facilityName').val(facilityName);

                $('#editCategoryForm').attr('action', '/facility/' + facilityId);
